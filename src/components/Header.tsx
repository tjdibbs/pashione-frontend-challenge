...
function Header() {
  ...
  return (
    <Affix offsetTop={0}>
      <header className="app-header-container sticky top-0 py-4 bg-white dark:bg-gray-800 dark:text-white transition-all shadow-xl shadow-primary/5 mb-6 px-2 xs:p-3 xs:px-4 rounded-xl mx-4 mt-4 ">
        <div className="flex justify-end xs:justify-between flex-wrap  items-center">
          <div className="greetings flex-grow">
            <div className="flex flex-col w-full gap-y-1 items-start">
              ...
              <div className="hidden xs:block text-sm text-[#707070]">
